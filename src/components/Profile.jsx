...
const Profile = () =>
{
    return (
        <div className='max-w-5xl mx-auto px-5 py-3'>
            <div className="container w-full items-center md:justify-between justify-evenly h-screen flex flex-col-reverse md:flex-row">
                <div className='flex flex-col mt-3 md:mt-0 text-center md:text-left' >
                    <div>
                        ...
                        <div>
                            <button className='bg-green-600 shadow-green-700/75 shadow-md w-44 mt-4 rounded-full text-white py-2 px-0 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-green-100 '>Download CV</button>
                        </div>
                    </div>
                </div>
